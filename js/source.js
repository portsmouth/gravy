...
var Source = function(glRenderer, glScene, glCamera, controls) 
{
...
Source.prototype.buildEmitterGeo = function()
{
	var group = this.group;
...
Source.prototype.resize = function(width, height)
{
...
Source.prototype.getDepthTarget = function()
{
	return this.depthTarget;
}

// get world position of emission point
Source.prototype.getPoint = function()
{
...
Source.prototype.getDirection = function()
{
	return this.getY();
}


Source.prototype.getEuler = function()
{
	return this.eulerAngles;
}

Source.prototype.getX = function()
{
...
Source.prototype.getY = function()
{
...
Source.prototype.getZ = function()
{
...
Source.prototype.getEmissionRadius = function()
{
...
Source.prototype.toggleVisibility = function(visible)
{
	var group = this.objects["group"];
	group.visible = visible;
}

Source.prototype.isVisible = function(visible)
{
	var group = this.objects["group"];
...
Source.prototype.setPosition = function(position)
{
	var group = this.objects["group"];
...
Source.prototype.setDirection = function(direction)
{
...
Source.prototype.setEuler = function(euler)
{
...
Source.prototype.setTarget = function(target)
{
...
Source.prototype.unsetTarget = function()
{
	this.targetSet = false;
}

Source.prototype.setEmissionRadius = function(radius)
{
...
// In degrees
Source.prototype.setEmissionSpreadAngle = function(spreadAngleDegrees)
{
	this.emissionSpread = spreadAngleDegrees;
}

Source.prototype.onMouseMove = function(event)
{
...
Source.prototype.onMouseDown = function(event)
{
...
Source.prototype.onMouseUp = function(event)
{
